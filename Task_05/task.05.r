setwd("C:/users/faiththarp/evolution/tasks/task_05")
library(adegenet)
library(poppr)
library(dplyr)
library(hierfstat)
...
plot(He_lobster , Ho_lobster , xlab = "expected H", ylab="observed H",
     pch=21, bg="gray", xlim=c(0.32, 0.405), ylim=c(0.32, 0.405))
abline(0,1, lty=3)
